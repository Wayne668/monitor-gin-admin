...
type HostAccount struct {
	...
	AdvCompanyName string `json:"advCompanyName" gorm:"column:adv_company_name;type:varchar(100);NOT NULL;DEFAULT:'';comment:客户公司名称"`
...
type HostAccountForm struct {
	...
	AdvCompanyName string `json:"advCompanyName" binding:"max=100"`
}
...
func (a *HostAccountForm) FillTo(item *HostAccount) {
	...
	item.AdvCompanyName = a.AdvCompanyName
}
